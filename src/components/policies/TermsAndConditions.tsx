...
import { TermsConditionsProps } from "lib/types/contentful";

export default function TermsAndConditions({ data }: TermsConditionsProps) {
  return (
    <div>
      {/* <Header user={user} /> */}
        ...
        <div className="container m-auto px-12 pt-52 pb-40">
          <ScrollReveal delay={0.2}>
            <h1 className="font-medium !text-left heroTextAnimate leading-0">
              <span className="txtBlue">Terms &</span>
              <span className="txtYellow"> Conditions </span>
            </h1>
            <div
